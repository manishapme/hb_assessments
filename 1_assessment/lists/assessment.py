...
def all_odd(numbers):
    ...
    For example::
        ...
        []
    """
    # using list comprehension to sreturn only values where there is a remainder
...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    # refactored to one line using notation & for intersection
...
def every_other_item(items):
    ...
    # refactored to use slicing to grab only values at every other position using step
...
def largest_n_items(items, n):
    ...
    separately::
        ...
        [3, 3]
    """
    # 0 is a special case, return empty list
    if n == 0:
        return []
